export const projectsInfiniteCardsContent = [
  {
  ...
  },
  {
    ...
    url: '/projects/cartesian-coordinate-robot',
  },
  {
    ...
    url: '/projects/bodily-awareness-control-and-vr',
  },
  {
    body: 'Focus of this work is an approach in which a robot is using a virtual or inner representation of its own body to ensure a safe and efficient interaction within the physical world. By analyzing correlations within its surroundings, the robot is able to plan task-oriented and socially accepting responses. This approach is inspired by the phenomenon called bodily awareness, which is found in humans.',
    title: 'Mixed reality applications',
    url: '/projects/mixed-reality-applications',
  },
  {
    body: 'Projects of our students text',
    title: 'Student projects',
    url: 'https://repozitorij.fsb.unizg.hr/islandora/search/tomislav%20stipan%C4%8Di%C4%87?type=dismax',
  },
];

export const projectsTabsContent = [
  {
    title: 'AMICORC Project',
  ...
  {
    title: 'Cartesian coordinate robot project',
    text: 'Cartesian coordinate robot is a part of the student work where all components are joint together manually and programmed. We use information visualization techniques to additionally control and program the robot. This work is supported by ProEL and RoboDK.',
    url: '/projects/cartesian-coordinate-robot',
  },
  {
    title: 'Bodily awareness control and virtual reality',
    text: 'Focus of this work is an approach in which a robot is using a virtual or inner representation of its own body to ensure a safe and efficient interaction within the physical world. By analyzing correlations within its surroundings, the robot is able to plan task-oriented and socially accepting responses. This approach is inspired by the phenomenon called bodily awareness, which is found in humans.',
    url: '/projects/bodily-awareness-control-and-vr',
  },
  {
    title: 'Mixed reality applications',
