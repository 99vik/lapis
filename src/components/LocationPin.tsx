  ...
  return (
    <div className="h-[300px] w-full flex items-center justify-center">
      <PinContainer title="Ul. Ivana Lučića 5, 10000, Zagreb">
        ...
        >
          <div className="flex basis-full justify-between text-center flex-col tracking-tight text-slate-100/50 sm:basis-1/2 w-[280px] h-[270px] ">
            ...
            <div className="text-base !m-0 !p-0 font-normal">
              <span className="text-slate-300 ">Open in Google maps</span>
            </div>
          </div>
        </a>
      </PinContainer>
