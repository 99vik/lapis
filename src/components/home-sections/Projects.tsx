...
export default function Projects() {
  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-3xl bg-zinc-900/40 border mb-10 gap-10 items-center py-10 px-4 sm:px-6 md:w-[80%] max-w-screen-xl mx-auto">
